...
4. [-Mahout-](http://mahout.apache.org) (out for the moment, [H2O can be used without Mahout, but Mahout can be an environment that executes on top of both H2O and Spark](https://www.quora.com/How-is-0xdatas-H2O-different-from-Apache-Mahout/answer/Cliff-Click-1).
...
7. unbbayes
8. javabayes
9. [Bayesian network tools for Java](http://bnj.sourceforge.net/)
